...
Verdict = Literal["WAN_UNSTABLE","WIFI_CONGESTION","MESH_FLAP","DFS_EVENT","OPAQUE_RISK","CABLE_PLANT_ISSUE","FWA_SIGNAL_WEAK","HEALTHY","UNKNOWN"]

DIAGNOSIS_MAP = {
    # Wi-Fi 7/8
    "P95_RTT_TOO_HIGH": "WAN_UNSTABLE",
    "P95_LOSS_TOO_HIGH": "WAN_UNSTABLE",
    "WIFI_SIDE_OSCILLATION": "WIFI_CONGESTION",
    "LOW_PHY_RATE": "WIFI_CONGESTION",
    "MESH_BACKHAUL_LIMITER": "MESH_FLAP",
    "MLO_ASYMMETRIC_LINK": "WIFI_CONGESTION",
    # FWA
    "WEAK_COVERAGE_RSRP_P5": "FWA_SIGNAL_WEAK",
    "LOW_SINR_P5": "FWA_SIGNAL_WEAK",
    "CELL_RESELECT_UNSTABLE": "WAN_UNSTABLE",
    "TAIL_RTT_TOO_HIGH": "WAN_UNSTABLE",
    "PEAK_CONGESTION_SUSPECT": "WAN_UNSTABLE",
    # Cable
    "T3T4_RETRY_BURST": "CABLE_PLANT_ISSUE",
    "TAIL_US_RTT_TOO_HIGH": "CABLE_PLANT_ISSUE",
    "TAIL_US_LOSS_TOO_HIGH": "CABLE_PLANT_ISSUE",
    "PLANT_IMPAIRMENT_SUSPECT": "CABLE_PLANT_ISSUE",
    # Generic
    "PASSED_ALL_CHECKS": "HEALTHY",
